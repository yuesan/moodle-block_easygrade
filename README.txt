...
* Rename the easygrade/ folder to the name of your module (eg "widget").
...
all the instances of the string "easygrade" to your module name
(eg "widget"). If you are using Linux, you can use the following command
$ find . -type f -exec sed -i 's/easygrade/widget/g' {} \;

* Rename the file lang/en/easygrade.php to lang/en/widget.php
where "widget" is the name of your module. Also rename block_easygrade.php
...
and you should find that this easygrade has been added to the list of
installed modules.
